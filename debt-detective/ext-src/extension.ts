  ...
  const jsonObject: any = [
    {
      ...
      vpkg: [
        ...
        },
        {
          CVE: "CVE-2022-41887",
          advisory:
            "Tensorflow 2.9.3 and 2.10.1 include a fix for CVE-2022-41887: receives a  and that are passed through  in . If the resulting dimensions overflow an 'int32', TensorFlow will crash due to a size mismatch during broadcast assignment.\r\nhttps://github.com/tensorflow/tensorflow/security/advisories/GHSA-8fvv-46hw-vpg3",
          package_name: "wrapt",
          analyzed_version: "1.12.",
        },
        {
